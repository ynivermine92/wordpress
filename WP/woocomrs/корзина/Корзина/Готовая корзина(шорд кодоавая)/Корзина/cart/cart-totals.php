...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-delivery">
			...
			<td data-title="<?php esc_attr_e('Delivery', 'woocommerce'); ?>">
				<?php
		...
		?>
				...
				?>
				<tr class="tax-total">
					<th>fff<?php echo esc_html(WC()->countries->tax_or_vat()) . $estimated_text; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							?></th>
